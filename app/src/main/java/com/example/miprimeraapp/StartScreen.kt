...
@Composable
fun StartScreen(onStartDemo: (Rect) -> Unit) {
    ...
    BoxWithConstraints(
        ...
        Column(
            ...
            Box(Modifier.fillMaxWidth().height(pageHeight * 0.52f).onGloballyPositioned {
            ...
            Column(
                ...
                Button(
                    ...
                    colors = ButtonDefaults.buttonColors(
                        ...
                        disabledContainerColor = Color(0xFF0085FF),
    ...
    if (showInfo) {
        AlertDialog(
            ...
            title = { Text(stringResource(R.string.start_info_title)) },
            text = { Text(stringResource(R.string.start_info_body)) },
            confirmButton = {
